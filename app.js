...
const sampleResult = {
  ...
  className:'10th / SSC-II', year:'2026', exam:'Annual',
  subjects:[['English','78','100','A'],['Urdu','81','100','A'],['Mathematics','92','100','A+'],['Physics','84','100','A'],['Chemistry','79','100','A'],['Computer Science','88','100','A'],['Islamiyat','47','50','A+']]
};
...
function boardsForRegion(region){
  return region === 'All Pakistan' ? boards : boards.filter(b=>b.region === region);
}
...
regionEl.addEventListener('change',()=>{
  renderBoardOptions(regionEl.value);
});
...
function showResult(found,result=sampleResult){
  if(!found){
    resultContent.innerHTML=`<div class="result-head"><span class="eyebrow">RESULT SEARCH</span><h2>No record found</h2><div class="result-meta">No matching demo record is available for this search.</div></div><div class="notice" style="margin-top:20px"><strong>Development mode</strong><span>Try roll number <b>123456</b> or switch to Student Name and enter <b>Muhammad Ali</b>. Official board searches will be connected through authorized sources/API before launch.</span></div><div class="result-actions"><button class="secondary-btn primary" data-close>Back to search</button></div>`;
  } else {
